...
if st.button("🔍 Process Text") and input_text.strip():
    ...
    img_bytes.seek(0)
    st.download_button("📷 Download Plot as PNG", data=img_bytes, file_name="word_freq_plot.png", mime="image/png")
